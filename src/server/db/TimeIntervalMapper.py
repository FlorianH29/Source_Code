...
class TimeIntervalMapper(Mapper):
    ...
    def insert(self, time_interval):
        ...
        data = (time_interval.get_id(),
                ...
                time_interval.get_start_event_id(),
                time_interval.get_end_event_id(),
    ...
    def update(self, time_interval):
        ...
        data = (time_interval.get_last_edit(), time_interval.get_start_event_id(),
                time_interval.get_end_event_id(), time_interval.get_time_period(), time_interval.get_id())
        cursor.execute(command, data)
